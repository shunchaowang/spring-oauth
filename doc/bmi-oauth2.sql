...
START TRANSACTION;
USE `bmi-oauth2`;
INSERT INTO `bmi-oauth2`.`users` (`id`, `username`, `password`, `active`, `version`) VALUES (1, 'admin', '$2a$10$JBjifsPVdFsuiuPGsxgJs.p.exCgmAHvRFIHVXyRdqjq3RWQ/gJOW', 1, 0);
...
START TRANSACTION;
USE `bmi-oauth2`;
INSERT INTO `bmi-oauth2`.`clients` (`id`, `name`, `oauth2_client_id`, `active`, `version`) VALUES (1, 'bmi-oauth2-service', 'bmi-oauth2-service', 1, 0);
INSERT INTO `bmi-oauth2`.`clients` (`id`, `name`, `oauth2_client_id`, `active`, `version`) VALUES (2, 'test client 2', 'client2', 1, 0);
INSERT INTO `bmi-oauth2`.`clients` (`id`, `name`, `oauth2_client_id`, `active`, `version`) VALUES (3, 'test client 3', 'client3', 1, 0);
...
START TRANSACTION;
USE `bmi-oauth2`;
INSERT INTO `bmi-oauth2`.`roles` (`id`, `name`, `client_id`, `version`) VALUES (1, 'ROLE_ADMIN', 1, 0);
INSERT INTO `bmi-oauth2`.`roles` (`id`, `name`, `client_id`, `version`) VALUES (2, 'ROLE_USER', 1, 0);
...
START TRANSACTION;
USE `bmi-oauth2`;
INSERT INTO `bmi-oauth2`.`users_clients` (`user_id`, `client_id`, `owner`, `version`) VALUES (1, 1, 1, 0);
...
START TRANSACTION;
USE `bmi-oauth2`;
INSERT INTO `bmi-oauth2`.`users_roles` (`user_id`, `role_id`) VALUES (1, 1);
