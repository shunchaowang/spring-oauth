...
public class TokenController {
  ...
  /**
   * token store must be jdbc to support revoke token. the token can be uuid and jwt, as long as the
   * token is stored in the database. the token can be obtained from header Authorization or
   * injected Authentication object.
   *
   * @param authHeader
   * @return
   */
