...
public class AuthClientDetails implements ClientDetails {
  ...
  public Set<String> getAuthorizedGrantTypes() {
    ...
    return new HashSet<>(
        Arrays.asList(StringUtils.split(clientDetail.getAuthorizedGrantTypes(), ",")));
  }
  ...
  public Set<String> getRegisteredRedirectUri() {
    ...
    return new HashSet<>(
        Arrays.asList(StringUtils.split(clientDetail.getWebServerRedirectUri(), ",")));
  }
  ...
  public Collection<GrantedAuthority> getAuthorities() {
    ...
    Arrays.stream(StringUtils.split(clientDetail.getAuthorities(), ","))
        .forEach(
            (auth) -> {
  ...
  public boolean isAutoApprove(String scope) {
    return "1".equals(clientDetail.getAutoApprove())
        || Boolean.valueOf(clientDetail.getAutoApprove());
  }
